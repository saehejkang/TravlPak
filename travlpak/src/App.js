    ...
    <div className="home">
      <div className="map" style={{ backgroundImage: `url(${map})` }}>
        <div className="overlap-group6">
          <div className="bio">
            <div className="bio-item sfprotext-bold-outer-space-18px">{aboutMeTitle}</div>
          ...
          <div className="greeting">
            <div className="hello sfprodisplay-light-outer-space-18px">{greetingHello}</div>
      ...
      <div className="three-box-group">
        <div className="friends border-1px-stromboli">
          <div className="weight sfprotext-bold-stromboli-13px">{friendRequestsTitle}</div>
          <div className="x45 sfprotext-bold-asphalt-20px">{friendRequestsNumber}</div>
        </div>
        <div className="messages border-1px-stromboli">
          <div className="new-messages-title sfprotext-bold-stromboli-13px">{newMessagesTitle}</div>
        ...
        <div className="requests border-1px-stromboli">
          <div className="planned-trips sfprotext-bold-stromboli-13px">{plannedTripsTitle}</div>
          ...
          <div className="trips-taken">
            <div className="trips-taken-box" style={{ backgroundImage: `url(${greenBox})` }}>
              <div className="flex-col-3">
                <div className="trips-taken-1 sfprotext-bold-white-16px">{tripsTakenTitle}</div>
          ...
          <div className="saved-locations">
            <div className="overlap-group-2" style={{ backgroundImage: `url(${orangeBox})` }}>
              <div className="overlap-group-3">
                ...
                <div className="saved-locations-1 sfprotext-bold-white-16px">{savedLocationsTitle}</div>
              </div>
          ...
          <div className="contries-traveled">
            <div className="overlap-group-2" style={{ backgroundImage: `url(${greenBox})` }}>
              <div className="overlap-group-3">
                ...
                <div className="countries-traveled sfprotext-bold-white-16px">{countriesTraveledTitle}</div>
              </div>
          ...
          <div className="flights-box">
            <div className="overlap-group-1" style={{ backgroundImage: `url(${greenBox})` }}>
              <div className="flex-col-1">
                <div className="flights-boarded sfprotext-bold-white-16px">{flightsBoardedTitle}</div>
      ...
      <div className="tab-bar">
        <div className="overlap-group1">
          <div className="icons">
            ...
            <div className="group" style={{ backgroundImage: `url(${profilePressed})` }}>
              <img src={profileIcon} alt="profile icon"/>
              <div className="profile sfprotext-normal-white-16px">{profileText}</div>
            </div>
          </div>
        </div>
      </div>
...
const homeData = {
    ...
    friendRequestsTitle: <>Friend<br />Requests</>,
    friendRequestsNumber: "12",
    newMessagesTitle: <>New<br />Messages</>,
    newMessagesNumber: "2",
    plannedTripsTitle: <>Planned<br />Trips</>,
    plannedTripsNumber: "1",
    tripsTakenTitle: <>trips<br />taken</>,
    tripsTakenNumber: "6",
    savedLocationsTitle: <>saved <br />locations</>,
    savedLocationsNumber: "2",
    countriesTraveledTitle: <>countries<br />traveled</>,
    countriesTraveledNumber: "4",
    flightsBoardedTitle: <>flights <br />boarded</>,
