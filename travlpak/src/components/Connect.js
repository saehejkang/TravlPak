...
function ChatMessage(props) {
  ...
  firebase
    .storage()
    .ref("ProfilePicutres/" + auth.currentUser.uid)
    .getDownloadURL()
    .then((imgURL) => {
  ...
  return (
    <>
      <div className={`message ${messageClass}`}>
        <img
          className="global-chat-profile-picture"
  ...
  return (
    <div className="tab-bar">
      <div className="white-box">
        ...
        <Link to="/home">
          <img
            className="connect-profile-icon"
            src={profileIcon}
            alt="connect icon"
          />
        </Link>
