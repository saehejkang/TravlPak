  ...
  render() {
    return (
      <div className="plan">
        ...
        <input className="start-date-input" type="date" value={this.startDate} onChange={(e) => this.setState({ startDate: e.target.value })}/>
        <input className="end-date-input" type="date" value={this.endDate} onChange={(e) => this.setState({ endDate: e.target.value })}/>
